...
four gigajoules per person (see \cref{def:baseline-energy}).
%
...
\caption{Placeholder figure for \cref{fig:battery-van}.}
...
\centering
  ...
  \centering
  \fbox{\rule{0pt}{0.18\textheight}\rule{0.9\linewidth}{0pt}}
  \caption{Placeholder (space elevator).}
  \label{fig:alternatives:elevator}
  \end{subfigure}
  \begin{subfigure}[b]{\linewidth}
  \centering
  \fbox{\rule{0pt}{0.18\textheight}\rule{0.9\linewidth}{0pt}}
  \caption{Placeholder (nuclear pulse).}
